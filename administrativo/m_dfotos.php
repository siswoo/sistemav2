...
<div class="container mt-3">
	<div class="col-12 text-center" style="font-weight: bold; font-size: 20px;">FOTOS</div>
	<div class="row mt-3" id="fotos2_respuesta">aqui</div>
</div>
		...
		$.ajax({
			...
			success: function(respuesta) {
				...
				if(respuesta["estatus"]=="ok"){
					$('#fotos2_respuesta').html(respuesta["html_fotos2"]);
				}
			},
