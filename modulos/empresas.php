...
<!-- Modal Nuevo Registro -->
	<div class="modal fade" id="nuevo_registro1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<form action="#" method="POST" id="nuevo_registro1_form" style="">
					    ...
					    <div class="row">
						    ...
						    <div class="col-12 form-group form-check">
							    ...
							    <select name="modulo" id="modulo" class="form-control" required>
							    	...
							    	<?php
							    	$sql10 = "SELECT * FROM modulos WHERE nombre != 'modulos'";
						    ...
						    <div class="col-12 form-group form-check">
							    ...
							    <select name="submodulo" id="submodulo" class="form-control" required>
							    	<option value="">Seleccione</option>
							    	<?php
							    	$sql10 = "SELECT * FROM modulos_sub WHERE id_modulos != 6";
							    	$proceso10 = mysqli_query($conexion,$sql10);
										while($row10 = mysqli_fetch_array($proceso10)) {
											echo '
												<option value="'.$row10["id"].'">'.$row10["nombre"].'</option>
						    ...
						    <div class="col-12 form-group form-check">
							    <label for="empresa" style="font-weight: bold;">Para Empresa</label>
							    <select name="empresa" id="empresa" class="form-control" required>
							    	<option value="">Seleccione</option>
							    	<?php
							    	$sql10 = "SELECT * FROM empresas";
							    	$proceso10 = mysqli_query($conexion,$sql10);
										while($row10 = mysqli_fetch_array($proceso10)) {
											echo '
												<option value="'.$row10["id"].'">'.$row10["nombre"].'</option>
...
<script>
	...
	function activar1(modulos_empresas_id){
		$.ajax({
			type: 'POST',
			url: '../script/crud_modulos.php',
			dataType: "JSON",
	...
	function inactivar1(modulos_empresas_id){
		$.ajax({
			type: 'POST',
			url: '../script/crud_modulos.php',
			dataType: "JSON",
